...
public class StringHelper {
    ...
    private final static String REGEX = "^\\d+(\\.0)?$";
    ...
    public static String join(String separator, String[] strings) {
        ...
        StringBuffer sb = new StringBuffer(length * strings[0].length()).append(strings[0]);
    ...
    public static String join(String separator, Iterator objects) {
        ...
        while (objects.hasNext()) {
            sb.append(separator).append(objects.next());
        }
        return sb.toString();
    }
     ...
     * @return
     */
    public static String[] add(String[] x, String separator, String[] y) {
        String[] result = new String[x.length];
        for (int i = 0; i < x.length; i++) {
            result[i] = x[i] + separator + y[i];
        }
        return result;
    }
    ...
    public static String replace(String source, String old, String replace) {
        ...
        int oldLenth = old.length();
        int posStart = 0;
        int pos;

        while ((pos = source.indexOf(old, posStart)) >= 0) {
            outStr.append(source.substring(posStart, pos));

            outStr.append(replace);
            posStart = pos + oldLenth;
        }
        if (posStart < sourceLenth) {
            outStr.append(source.substring(posStart));
        }
    ...
    public static void main(String[] args) {
        ...
        StringBuffer sb = new StringBuffer();
        int pos;
        StringTokenizer tokens = new StringTokenizer(str, s, true);
        String[] result = new String[tokens.countTokens()];
        int i = 0;
        while (tokens.hasMoreTokens()) {
            result[i++] = tokens.nextToken();
